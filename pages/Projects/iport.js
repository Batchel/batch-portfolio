        ...
        <div className={utilStyles.mainproj}>
            ...
            <div>
                    ...
                    <section className={utilStyles.projectpar}>
                        <p>
                        This is a hand strap and stand that I worked on developing at IPORT 
                    ...
                    <section className={utilStyles.projectpar}>
                            <Link href="/Projects/iport2">
                                <a className={utilStyles.menu}> + If you want to see other small side projects I did while at IPORT, <b>click here!</b> </a>
                            </Link>
                    </section>
                    ...
                    <section className={utilStyles.projectpar}>
                        <p>
                        I started by exploring all of the ways to interact with an iPad and stand, 
                        ...
                        What surfaces will the iPad be used on? What parts of the stand matter most?
                        </p>
                    </section>
                    ...
                    <section className={utilStyles.projectpar}>
                        <p>
                        I worked closely with our industrial designer at IPORT to evaluate different forms, making 
                    ...
                    <section className={utilStyles.projectpar}>
                        <p>
                        There are existing locking holes on the IPORT iPad case for other products, which 
                    ...
                    <section className={utilStyles.projectpar}>
                        <p>
                        After developing a few designs within the project parameters, I decided to explore
                        ...
                        we had provided with our current design. I went about designing a new handstrap that was built for only 2.
                        </p>
                    </section>
